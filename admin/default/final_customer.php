...
<div class="adminx-content">
    <div class="adminx-main-content">
        <div class="container-fluid">
            ...
            <div class="pb-3">
                <h1><b><i>List of Final Thailand Package </i></b></h1>
            </div>
            <!-- <div class="row">
              <div class="col">
                    ...
                    <div class="card mb-grid">
                        <div class="table-responsive-md">
                            <table class="table table-actions table-striped table-hover mb-0" data-table>
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM `thailand_customers` WHERE status = 'confirm' ORDER BY create_date DESC";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="thailand_package_document?reff_id=<?php echo $row['reff_id']; ?>" class="text-white btn btn-sm btn-info">
